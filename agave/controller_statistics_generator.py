...
#    return new_cca
    [ccp.remove({'concept_to':ccpe['concept_from'], 'concept_from': ccpe['concept_to']}) for ccpe in ccp  if {'concept_to':ccpe['concept_from'], 'concept_from': ccpe['concept_to']} in ccp]
    return cca
